...
(* Nombres entiers : A COMPLETER *)
  | (chiffre | chiffre (['1' - '9'] (chiffre| _ )* chiffre)) as texte   { (ENTIER (int_of_string texte)) }
  | ('0' | '1') | ('0'|'1') (('0'|'1'|_)* ('0'|'1')) as texte   { (ENTIER (int_of_string texte)) }
  | ['0' - '7'] | ['0'-'7'] ((['0'-'7']|_)* ['0'-'7']) as texte   { (ENTIER (int_of_string texte)) }
  | ['0'-'9' 'A'-'F']* as texte   { (ENTIER (int_of_string texte)) }
  | ['0'-'9' 'a'-'f']* as texte   { (ENTIER (int_of_string texte)) }
